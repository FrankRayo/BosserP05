...
// MongoDB (cliente, tipos y ObjectId)
export { MongoClient, Bson, ObjectId } from "https://deno.land/x/mongo@v0.31.2/mod.ts";

// CORS middleware
export { oakCors } from "https://deno.land/x/cors@v1.2.1/mod.ts";

// bcrypt para encriptación de contraseñas (funciones y módulo completo)
...
// SMTP para envío de correos (Deno)
export { SMTPClient } from "https://deno.land/x/denomailer/mod.ts";

// Utilidades y tipos para testing (solo usar en archivos de test)
